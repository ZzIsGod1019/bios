use bios_basic::rbum::{dto::rbum_filer_dto::{RbumBasicFilterReq, RbumItemFilterFetcher, RbumItemRelFilterReq}, rbum_enumeration::RbumScopeLevelKind};
use serde::{Deserialize, Serialize};
use tardis::{basic::field::TrimString, chrono::{DateTime, Utc}, db::sea_orm::{self, prelude::*, EnumIter},serde_json::Value, web::poem_openapi, TardisFuns};

use super::{flow_state_dto::{FlowStateAddReq, FlowStateAggResp}, flow_transition_dto::{FlowTransitionAddReq, FlowTransitionModifyReq}};
